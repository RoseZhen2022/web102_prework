...
const unfundedGames = GAMES_JSON.filter((game) => game.pledged < game.goal);
const totalUnfundedGames = unfundedGames.reduce((acc, game) => acc + 1, 0)
...
descriptionTop.textContent = topFundedGame;
document.getElementById("first-game").appendChild(descriptionTop);

// do the same for the runner up item
const secondFundedGame = secondGame.name;
const descriptionSecond = document.createElement("div");
descriptionSecond.textContent = secondFundedGame;
document.getElementById("second-game").appendChild(descriptionSecond);